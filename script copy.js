...
function main(){
    ...
    const texture = textureLoader.load("imgs/online-tetris.png"); // 画像を読み込む
    ...
    function makeInstance(index){
        ...
        loader.load('https://raw.githubusercontent.com/mrdoob/three.js/dev/examples/fonts/gentilis_bold.typeface.json', function (font) {
            const geometry = new TextGeometry('Online Tetris', {
                font: font,
    ...
    function loadSword() {
        ...
        fbxLoader.load(
            ...
            (object) => {
                // Scale the sword if needed
                object.scale.setScalar(2); // Adjust scale as needed

                // Position the sword
                object.position.set(41, -10, 0.8); // Adjust position as needed
